...
// NOTE: This page is UI-only per request. No backend calls are made here.
// It renders the Task tab of the Staff Create Event flow, following the provided mockups and dimensions.
