...
export default function AllRecipes() {
    ...
    return (
        <div className="p-10 flex flex-col space-y-5">
            <button
                onClick={() => navigate({pathname: '/cookbook'})}
            >
            ...
            <Slideshow 
                ...
                <ImageCard 
                    src={placeholder}
                    caption="Breakfast"
                    onClick={() => navigate({pathname: '/cookbook/all-recipes/breakfast'})}
                />,
                <ImageCard 
                    src={placeholder}
                    caption="Lunch/Dinner"
                    onClick={() => navigate({pathname: '/cookbook/all-recipes/lunch-dinner'})}
                />,
                <ImageCard 
                    src={placeholder}
                    caption="Snack"
                    onClick={() => navigate({pathname: '/cookbook/all-recipes/snack'})}
                />,
                <ImageCard 
                    src={placeholder}
                    caption="Dessert"
                    onClick={() => navigate({pathname: '/cookbook/all-recipes/dessert'})}
                />
                ]}
                imagesPerRow={2} 
            />
