...
if (!isCompleted) { // Only allow if not already completed
      setShowCompletionPopup(true);
    }  };



  const handleClosePopup = (data?: { enjoyment: "YES" | "MAYBE" | "NO"; photoFile?: File }) => {
  ...
  return (
    <>
      <div className={styles.eventCard} style={cardStyle} onClick={handleCardClick}>
