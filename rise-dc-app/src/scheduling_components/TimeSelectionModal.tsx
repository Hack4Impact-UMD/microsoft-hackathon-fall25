    ...
    >
      ...
      <div className="time-input">
        <div className="time-unit">
          <button
            className="up-arrow"
            onClick={() => isActive && updateTime(timeType, "hour", true)}
          />
          <input
            ...
            onChange={(e) =>
              isActive &&
              updateTimeDirect(timeType, "hour", Number(e.target.value))
            }
          />
          <button
            className="down-arrow"
            onClick={() => isActive && updateTime(timeType, "hour", false)}
          />
        </div>
        ...
        <div className="time-unit">
          <button
            className="up-arrow"
            onClick={() => isActive && updateTime(timeType, "minute", true)}
          />
          <input
            className="time-text-input"
            type="number"
            ...
            onChange={(e) =>
              isActive &&
              updateTimeDirect(timeType, "minute", Number(e.target.value))
            }
          />
          <button
            className="down-arrow"
            onClick={() => isActive && updateTime(timeType, "minute", false)}
          />
        </div>
      </div>
    </div>
