...
export const addRecipe = (recipe: Recipe) =>
  addItem(recipe, COOKBOOK_DB, "Recipes");
export const getRecipes = () => getAllItems<Recipe>(COOKBOOK_DB, "Recipes");
export const getRecipe = (id: string) =>
  getItem<Recipe>(id, COOKBOOK_DB, "Recipes");
export const deleteRecipe = (id: string) =>
  deleteItem(id, id, COOKBOOK_DB, "Recipes");

//Ingredient
export const addIngredient = (ingredient: Ingredient) =>
  addItem(ingredient, COOKBOOK_DB, "Ingredients");
export const getIngredients = () =>
  getAllItems<Ingredient>(COOKBOOK_DB, "Ingredients");
export const getIngredient = (id: string) =>
  getItem<Ingredient>(id, COOKBOOK_DB, "Ingredients");
export const deleteIngredient = (id: string) =>
  deleteItem(id, id, COOKBOOK_DB, "Ingredients");
...
export const deleteTool = (id: string) =>
  deleteItem(id, id, COOKBOOK_DB, "Tools");

//Utensil
export const addUtensil = (utensil: Utensil) =>
  addItem(utensil, COOKBOOK_DB, "Utensils");
export const getUtensils = () => getAllItems<Utensil>(COOKBOOK_DB, "Utensils");
export const getUtensil = (id: string) =>
  getItem<Utensil>(id, COOKBOOK_DB, "Utensils");
export const deleteUtensil = (id: string) =>
  deleteItem(id, id, COOKBOOK_DB, "Utensils");

//Meal Prep
export const addMealPrep = (mealPrep: MealPrep) =>
  addItem(mealPrep, COOKBOOK_DB, "Meal Preps");
export const getMealPreps = () =>
  getAllItems<MealPrep>(COOKBOOK_DB, "Meal Preps");
export const getMealPrep = (id: string) =>
  getItem<MealPrep>(id, COOKBOOK_DB, "Meal Preps");
export const deleteMealPrep = (id: string) =>
  deleteItem(id, id, COOKBOOK_DB, "Meal Preps");

//Grocery list
export const addGroceryList = (groceryList: GroceryList) =>
  addItem(groceryList, COOKBOOK_DB, "Grocery Lists");
export const getGroceryLists = () =>
  getAllItems<GroceryList>(COOKBOOK_DB, "Grocery Lists");
export const getGroceryList = (id: string) =>
  getItem<GroceryList>(id, COOKBOOK_DB, "Grocery Lists");
export const deleteGroceryList = (id: string) =>
  deleteItem(id, id, COOKBOOK_DB, "Grocery Lists");
...
export const getTask = (id: string) =>
  getItem<Task>(id, SCHEDULING_DB, "Tasks");
export const deleteTask = (id: string) =>
  deleteItem(id, id, SCHEDULING_DB, "Tasks");

// Events
export const addEvent = (event: Event) =>
  addItem(event, SCHEDULING_DB, "Events");
export const getEvents = () => getAllItems<Event>(SCHEDULING_DB, "Events");
export const getEvent = (id: string) =>
  getItem<Event>(id, SCHEDULING_DB, "Events");
...
export const addFeedback = (feedback: Feedback) =>
  addItem(feedback, SCHEDULING_DB, "Feedback");
export const getFeedback = () =>
  getAllItems<Feedback>(SCHEDULING_DB, "Feedback");
export const getFeedbackItem = (id: string) =>
  getItem<Feedback>(id, SCHEDULING_DB, "Feedback");
export const deleteFeedback = (id: string) =>
  deleteItem(id, id, SCHEDULING_DB, "Feedback");
...
export const deleteImage = (id: string) =>
  deleteItem(id, id, SHARED_DB, "Images");
